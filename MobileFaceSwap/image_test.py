...
def image_test(args):
    paddle.set_device('cpu')#paddle.set_device("gpu" if args.use_gpu else 'cpu')
    ...
    base_path = '/opt/ml/input/level3_cv_finalproject-cv-11/MobileFaceSwap/temp/'+base_path.split('/')[-1]
